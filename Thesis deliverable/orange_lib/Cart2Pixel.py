...
from orange_lib.MinRect import minimum_bounding_rectangle
...
def Cart2Pixel(Q=None, A=None, B=None, dynamic_size=False, mutual_info=False, only_model=False, params=None):
    ...
    # find duplicates
    print("Collision: " + str(find_duplicate(zp)))
    ...
    if only_model:
        ...
        # if not os.path.exists(os.path.dirname(params["dir"])):
        #     try:
        #         os.makedirs(os.path.dirname(params["dir"]))
        #     except OSError as exc:
        #         if exc.errno != errno.EEXIST:
        #             raise

        # filename = params["dir"] + "train" + name + ".pickle"
        # f_myfile = open(filename, 'w+b')
